...
module.exports = {
    gray(imgSrc){return draw(imgSrc,TYPE.grayscale)},
    gray2(imgSrc){return draw(imgSrc,TYPE.grayscale2)},
    invert(imgSrc){return draw(imgSrc,TYPE.invert)},
    color(imgSrc){return draw(imgSrc,TYPE.color)}
}
